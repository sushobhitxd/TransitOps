  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <Input required placeholder="e.g. TOLL, MAINTENANCE..." className="bg-white/5 border-white/10 text-white" />
      </div>
      <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <Input required placeholder="Brief description..." className="bg-white/5 border-white/10 text-white" />
      </div>
